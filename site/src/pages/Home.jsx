...
// Hash navigation helpers (no react-router required)
const goDocs = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <a
              href="#get-started"
              className="inline-flex bg-yellow-400 hover:bg-yellow-500 text-slate-900 px-5 py-2 rounded-lg font-bold text-sm transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(250,204,21,0.3)]"
            >
              Get Started
            </a>
          </div>
        ...
        <div className="md:hidden bg-slate-900 border-b border-slate-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a
              onClick={close}
              href="#get-started"
              className="block bg-yellow-400 text-slate-900 mt-4 px-5 py-3 rounded-lg font-bold"
            >
              Get Started
            </a>
          </div>
...
const Hero = () => {
  return (
    <div className="relative bg-slate-950 pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-yellow-400 opacity-20 blur-[100px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-xl text-slate-400 mb-10">
          Unify local GPUs, Colab notebooks, and cloud instances into one OpenAI-compatible API endpoint. No VPNs. No port
          forwarding. Just code.
        </p>

        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="#get-started"
            className="flex items-center justify-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-slate-950 px-8 py-4 rounded-lg font-bold text-lg transition-all transform hover:-translate-y-1 shadow-[0_0_20px_rgba(250,204,21,0.4)]"
          >
            Get Started in 60s
          ...
          <button
            onClick={goDocs}
            className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 px-8 py-4 rounded-lg font-semibold text-lg transition-all"
          >
        ...
        {/* Terminal Strip */}
        <div id="get-started" className="mt-16 mx-auto max-w-4xl">
            ...
            <div className="p-6 bg-slate-950 font-mono text-sm leading-relaxed text-slate-300 relative">
              ...
              <div className="relative border border-yellow-500/80 rounded-sm p-5 my-6 bg-slate-900/50">
                ...
                <div className="grid grid-cols-[80px_1fr] gap-y-2 text-sm">
                  ...
                  <div className="text-blue-400 underline decoration-blue-400/30 underline-offset-2">
              ...
              <div className="mt-4">
                <span className="text-green-500 font-bold mr-2">➜</span>
                <span className="text-blue-400 font-bold mr-2">~</span>
                <span className="animate-pulse inline-block w-2.5 h-5 bg-slate-500 align-middle" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Traditional setups require complex networking. OllaBridge flips the model: compute nodes dial{" "}
            <span className="text-yellow-400 font-semibold"> out</span> to the gateway.
          </p>
        </div>
        ...
        <div className="relative h-[400px] md:h-[500px] w-full bg-slate-950 rounded-2xl border border-slate-800 shadow-2xl flex items-center justify-center overflow-hidden">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none z-10" aria-hidden="true">
            ...
            <path
              d="M calc(100% - 120px) 120 L 50% 50%"
              stroke="url(#line-gradient)"
              strokeWidth="2"
              strokeDasharray="5,5"
              className="animate-pulse opacity-50"
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
            <div className="absolute top-[28%] left-[28%] w-2 h-2 bg-yellow-400 rounded-full shadow-[0_0_10px_#facc15] animate-ping" />
            <div className="absolute top-[28%] right-[28%] w-2 h-2 bg-yellow-400 rounded-full shadow-[0_0_10px_#facc15] animate-ping anim-delay-75" />
            <div className="absolute bottom-[28%] left-[50%] w-2 h-2 bg-yellow-400 rounded-full shadow-[0_0_10px_#facc15] animate-ping anim-delay-150" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12 items-center">
        <div className="lg:w-1/2">
          ...
          <p className="text-slate-400 text-lg mb-8">
            Don&apos;t rewrite your codebase. OllaBridge mimics the OpenAI API standard perfectly. Whether you&apos;re using
            LangChain, Vercel AI SDK, or raw cURL, it just works.
          </p>
        ...
        <div className="lg:w-1/2 w-full">
          <div className="bg-slate-900 rounded-xl border border-slate-800 shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 bg-slate-800 border-b border-slate-700">
              ...
              <div className="flex items-center text-slate-500 hover:text-white" title="Copy code" aria-hidden="true">
    ...
    <section id="features" className="py-24 bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">Infrastructure headaches shouldn&apos;t stop you from shipping AI apps.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="p-8 bg-slate-950 rounded-2xl border border-slate-800 hover:border-yellow-400/50 transition-all duration-300 group"
            >
    ...
    <section className="py-24 bg-gradient-to-br from-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="#get-started"
            className="bg-yellow-400 hover:bg-yellow-500 text-slate-900 px-8 py-4 rounded-lg font-bold text-lg transition-all shadow-lg transform hover:-translate-y-1"
          >
            Get Started Now
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 px-8 py-4 rounded-lg font-bold text-lg transition-all flex items-center justify-center gap-2"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <button onClick={goDocs} className="text-slate-400 hover:text-white transition-colors">
              Documentation
            </button>
            <a
              href="https://github.com/ruslanmv/ollabridge"
            ...
            <a
              href="https://github.com/ruslanmv/ollabridge/blob/master/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-white transition-colors"
            >
